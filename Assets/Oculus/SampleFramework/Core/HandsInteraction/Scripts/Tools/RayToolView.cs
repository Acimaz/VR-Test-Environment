...
namespace OculusSampleFramework
{
	...
	public class RayToolView : MonoBehaviour, InteractableToolView
	{
		...
		private void Update()
		{
			...
			// var myPosition = InteractableTool.IsRightHandedTool ? rightHandAnchor.position : leftHandAnchor.position;
			// var myForward = InteractableTool.IsRightHandedTool ? -rightHandAnchor.right : leftHandAnchor.right;
