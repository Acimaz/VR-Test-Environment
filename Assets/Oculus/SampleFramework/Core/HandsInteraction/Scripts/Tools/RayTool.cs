...
namespace OculusSampleFramework
{
	...
	{
		private const float MINIMUM_RAY_CAST_DISTANCE = 0.1f;
		private const float COLLIDER_RADIUS = 0.001f;
		...
		{ 
			...
			//return (IsRightHandedTool ? rightHandAnchor.position : leftHandAnchor.position ) + MINIMUM_RAY_CAST_DISTANCE * (IsRightHandedTool ? -rightHandAnchor.right : leftHandAnchor.right );
		}
