...
namespace OculusSampleFramework
{
	public class HandsManager : MonoBehaviour
	{
		...
		[SerializeField] protected SkinnedMeshRenderer leftHandMeshRenderer, rightHandMeshRenderer;
		...
		protected SkinnedMeshRenderer _leftMeshRenderer = null;
		protected SkinnedMeshRenderer _rightMeshRenderer = null;
		...
		public void TestSetup(GameObject leftHand, GameObject rightHand, SkinnedMeshRenderer leftMeshRenderer, SkinnedMeshRenderer rightMeshRenderer)
		{
			if (leftHand != null)
			{
				_leftHand = leftHand;
			...
			{
				leftHandMeshRenderer = leftMeshRenderer;
			}

			if (rightMeshRenderer != null)
			{
				rightHandMeshRenderer = rightMeshRenderer;
			}
		}
